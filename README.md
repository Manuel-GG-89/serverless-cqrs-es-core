...
Taking all of the above into consideration, a basic composition of a Domain Aggregate have, at least: 
  ...
  - An async, low-latency, API. In this context, Graphql can by good. But you can implement your own protocol over websocket or you sefl-maded fine-tunned channel. The point is that it must be able to communicate with the SSR servers (server-to-server clients) in a simple, secure and efficient way.
