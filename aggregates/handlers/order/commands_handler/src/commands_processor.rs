use shared_library::current_state::get_aggregate_state;
...
use chrono::Utc; 
use shared_library::get_dynamodb_client;
use shared_library::event_emitter::emit_event;
...
pub async fn create_order(event: &AppsyncEvent) -> Result<AppsyncObjectResponse, Error> {
    // lambda_runtime::tracing::info!(String::from("create_order"));
