...
I am currently learning this language and generating some simple proposals to demonstrate how the system of type of language can be approved in this context.But it is a job in process, I will upload some examples when I have something more orderly.
