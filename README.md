...
- Express all operations as functions, and that these receive as arguments all the arguments they need to operate (even the 'clients' to connect to the different APIs must be passed as arguments)
