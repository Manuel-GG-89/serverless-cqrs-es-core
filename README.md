...
*** 
WARNING: Engineers and FRONT-END developers, unless you only need to serve static websites, very little interaction and no user authentication/authorization, I recommend you DO NOT USE SERVERLESS ENVIRONMENTS ON YOUR SSR SERVERS.
