...
Another example: In passenger transport systems, by their nature, each signal recived by a bus, train, aeroplane, and any other, they are also stored as a succession of immutable events (GPS and sensors signals).
